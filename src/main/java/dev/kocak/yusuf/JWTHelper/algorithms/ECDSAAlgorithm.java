...
class ECDSAAlgorithm extends Algorithm {
    ...
    private final IECDSAKeyProvider keyProvider;
    private final CryptoHelper crypto;
    private final int ecNumberSize;

    //Visible for testing
    ECDSAAlgorithm(CryptoHelper crypto, String id, String algorithm, int ecNumberSize, IECDSAKeyProvider keyProvider)
    ...
    ECDSAAlgorithm(String id, String algorithm, int ecNumberSize, IECDSAKeyProvider keyProvider)
            throws IllegalArgumentException {
    ...
    //Visible for testing
    static IECDSAKeyProvider providerForKeys(final ECPublicKey publicKey, final ECPrivateKey privateKey) {
        if (publicKey == null && privateKey == null) {
            throw new IllegalArgumentException("Both provided Keys cannot be null.");
        }
        return new IECDSAKeyProvider() {
            @Override
